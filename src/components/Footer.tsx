...
export default function Footer() {
    return (
        <div className="flex flex-row justify-between items-center border-t border-gray-200 pt-4 p-2">
            ...
            <small className=" text-gray-500 italic">Disclaimer: This data is from the Solana blockchain and is updated periodically. IDLs and verification were correct at time of last update.</small>
            <DeployTimestamp />
        </div>
    )
}
